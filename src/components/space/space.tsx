  ...
  return (
    <div className="header-animate-container">
      <div className="space fade-in">
        ...
        <img src="images/space-elements/stars/star-1.svg" className='star-1 space__element' alt="" width={20} height={20}/>
        <img src="images/space-elements/stars/star-2.svg" className='star-2 space__element' alt="" width={16} height={16}/>
        <img src="images/space-elements/stars/star-3.svg" className='star-3 space__element' alt="" width={16} height={16}/>
        <img src="images/space-elements/stars/star-4.svg" className='star-4 space__element' alt="" width={8} height={8}/>
        <img src="images/space-elements/stars/star-5.svg" className='star-5 space__element' alt="" width={8} height={8}/>
        <img src="images/space-elements/stars/star-6.svg" className='star-6 space__element' alt="" width={8} height={8}/>
        <img src="images/space-elements/stars/star-7.svg" className='star-7 space__element' alt="" width={19} height={19}/>
        <img src="images/space-elements/stars/star-8.svg" className='star-8 space__element' alt="" width={19} height={19}/>
        <img src="images/space-elements/stars/star-9.svg" className='star-9 space__element' alt="" width={16} height={16}/>
